(ns localist.re-frame-firebase.firestore
  (:require
...
;(def firestore (js/require "firebase/firestore"))
...
(defn delete-field-value
  ...
  []
  (.delete (.. firebase -firestore -FieldValue)))
...
(defn clj->FieldPath
  ...
  (cond
    ...
    (coll? field-path) ((.. firebase -firestore -FieldPath.) (clj->js field-path))
